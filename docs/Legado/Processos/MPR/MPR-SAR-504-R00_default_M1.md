...
flowchart TD
    ...
    subgraph Container_ID_MPR_SAR_504_R00_0 [ ]
        direction TB
        ID_MPR_SAR_504_R00_0_Start((Início)):::inicio
        ID_MPR_SAR_504_R00_0_End(((Fim))):::fim
        ID_MPR_SAR_504_R00_0_01("<b>01. Verificar a pertinência temática da demanda</b><hr>Responsável: GTNI - Demandas Especiais."):::tarefaBPMN
        ID_MPR_SAR_504_R00_0_02("<b>02. Encaminhar matéria da SAR</b><hr>Responsável: GTNI - Demandas Especiais."):::tarefaBPMN
        ID_MPR_SAR_504_R00_0_03("<b>03. Avaliar composição da matéria</b><hr>Responsável: GTNI - Demandas Especiais."):::tarefaBPMN
        ID_MPR_SAR_504_R00_0_04("<b>04. Informar área responsável pela resposta</b><hr>Responsável: GTNI - Demandas Especiais."):::tarefaBPMN
        ID_MPR_SAR_504_R00_0_05("<b>05. Solicitar subsídios para áreas da SAR envolvidas</b><hr>Responsável: GTNI - Demandas Especiais."):::tarefaBPMN
        ID_MPR_SAR_504_R00_0_06("<b>06. Receber subsídios da SAR, compilar e enviar para área responsável pela resposta</b><hr>Responsável: GTNI - Demandas Especiais."):::tarefaBPMN
        ID_MPR_SAR_504_R00_0_07("<b>07. Solicitar subsídios para áreas envolvidas</b><hr>Responsável: GTNI - Demandas Especiais."):::tarefaBPMN
        ID_MPR_SAR_504_R00_0_08("<b>08. Compilar informações se preparar resposta à Procuradoria</b><hr>Responsável: GTNI - Demandas Especiais."):::tarefaBPMN
        ID_MPR_SAR_504_R00_0_09("<b>09. Compilar informações e preparar minuta de resposta externa à ANAC</b><hr>Responsável: GTNI - Demandas Especiais."):::tarefaBPMN
        ID_MPR_SAR_504_R00_0_10("<b>10. Assinar a resposta</b><hr>Responsável: O SAR."):::tarefaBPMN
        ID_MPR_SAR_504_R00_0_Start --> ID_MPR_SAR_504_R00_0_01
        gw_ID_MPR_SAR_504_R00_0_01{"Há matéria de atribuição da SAR?"}:::gatewayBPMN
        ID_MPR_SAR_504_R00_0_01 --> gw_ID_MPR_SAR_504_R00_0_01
        gw_ID_MPR_SAR_504_R00_0_01 -->|"sim, há matéria de atribuição da SAR"| ID_MPR_SAR_504_R00_0_03
        gw_ID_MPR_SAR_504_R00_0_01 -->|"não, não há matéria de atribuição da SAR"| ID_MPR_SAR_504_R00_0_02
        ID_MPR_SAR_504_R00_0_02 --> ID_MPR_SAR_504_R00_0_End
        gw_ID_MPR_SAR_504_R00_0_03{"A SAR deve responder à demanda?"}:::gatewayBPMN
        ID_MPR_SAR_504_R00_0_03 --> gw_ID_MPR_SAR_504_R00_0_03
        gw_ID_MPR_SAR_504_R00_0_03 -->|"não, outra área deve responder"| ID_MPR_SAR_504_R00_0_04
        gw_ID_MPR_SAR_504_R00_0_03 -->|"sim, a SAR deve responder"| ID_MPR_SAR_504_R00_0_07
        ID_MPR_SAR_504_R00_0_04 --> ID_MPR_SAR_504_R00_0_05
        ID_MPR_SAR_504_R00_0_05 --> ID_MPR_SAR_504_R00_0_06
        ID_MPR_SAR_504_R00_0_06 --> ID_MPR_SAR_504_R00_0_End
        gw_ID_MPR_SAR_504_R00_0_07{"Demanda oriunda da Procuradoria?"}:::gatewayBPMN
        ID_MPR_SAR_504_R00_0_07 --> gw_ID_MPR_SAR_504_R00_0_07
        gw_ID_MPR_SAR_504_R00_0_07 -->|"sim, demanda oriunda da Procuradoria"| ID_MPR_SAR_504_R00_0_08
        gw_ID_MPR_SAR_504_R00_0_07 -->|"não, demanda oriunda de orgãos externos à ANAC"| ID_MPR_SAR_504_R00_0_09
        ID_MPR_SAR_504_R00_0_08 --> ID_MPR_SAR_504_R00_0_10
        ID_MPR_SAR_504_R00_0_09 --> ID_MPR_SAR_504_R00_0_10
        ID_MPR_SAR_504_R00_0_10 --> ID_MPR_SAR_504_R00_0_End
    end
    click ID_MPR_SAR_504_R00_0_01 href "#" "Demandas Especiais podem envolver assuntos atinentes às atribuições de mais de uma superintendência. Assim sendo, assim que uma demanda é recebida, é necessário verificar as superintendências envolvidas.  Caso não haja matéria atinente às atribuições da SAR, o processo tem de ser direcionado às superintendências responsáveis pela resposta (02) e encerra-se a atuação da SAR."
    click ID_MPR_SAR_504_R00_0_02 href "#" "Caso não haja matéria atinente às atribuições da SAR, o processo tem de ser direcionado às superintendências responsáveis pela resposta e encerra-se a atuação da SAR.  A ação tomada é mero encaminhamento às superintendências responsáveis."
    click ID_MPR_SAR_504_R00_0_03 href "#" "Neste momento, sabe-se que a SAR é responsável ao menos por parte da resposta, ocorre que Demandas Especiais podem envolver assuntos atinentes às atribuições de mais de uma superintendência.  Assim sendo, é necessário verificar se há mais superintendências envolvidas.  Caso não haja matéria atinente às atribuições de outras superintendências, o processo é respondido unicamente pela SAR.  Caso haja matéria atinente às atribuições de outras superintendências, o processo deve ser respondido pela superintendência responsável pela maior parte das respostas."
    click ID_MPR_SAR_504_R00_0_04 href "#" "Caso haja matéria atinente às atribuições de outras superintendências, o processo tem de ser direcionado à superintendência responsável pela resposta.  A ação tomada é mero encaminhamento à superintendência responsável."
    click ID_MPR_SAR_504_R00_0_05 href "#" "Uma vez que se sabe que na demanda há matéria da SAR, a mesma é encaminhada às áreas técnicas da SAR pertinentes para que prestem seus subsídios.  Um prazo para a resposta é informado às áreas."
    click ID_MPR_SAR_504_R00_0_06 href "#" "Após recebimento dos subsídios das áreas, é verificado se as informações são pertinentes e se respondem devidamente à demanda.  Em caso afirmativo, é elaborado um documento do mesmo tipo do que contem a demanda original (se a demanda vem num ofício, um ofício é criado, caso venha num memorando, um memorando é criado) e a resposta é criada.  Antes de ser encaminhada ao superintendente, a proposta de resposta é submetida à aprovação do GTPN."
    click ID_MPR_SAR_504_R00_0_07 href "#" "ao demandante, as perguntas relativas a matérias da SAR são encaminhadas às áreas técnicas da SAR pertinentes para que prestem seus subsídios.  Além disso, é verificado se há matérias atinentes a outras superintendências. Em caso afirmativo, as perguntas que não devem ser respondidas pela SAR são encaminhadas as superintendências pertinentes. Estas devem prestar os subsídios de suas áreas de atuação.  Um prazo para a resposta é informado às áreas."
    click ID_MPR_SAR_504_R00_0_08 href "#" "Após recebimento dos subsídios das áreas técnicas da SAR, é verificado se as informações são pertinentes e se respondem devidamente à demanda.  Em caso afirmativo, é elaborado um memorando (pois as demandas da Procuradoria sempre vêm em forma de memorando) e a resposta é criada.  Antes de ser encaminhada ao superintendente, a proposta de resposta é submetida à aprovação do GTPN."
    click ID_MPR_SAR_504_R00_0_09 href "#" "Após recebimento dos subsídios das áreas técnicas da SAR e das demais superintendências envolvidas, é verificado se as informações são pertinentes e se respondem devidamente à demanda.  Em caso afirmativo, é elaborado um documento do mesmo tipo do que contem a demanda original (se a demanda vem num ofício, um ofício é criado, caso venha num memorando, um memorando é criado) e a resposta é criada.  Antes de ser encaminhada ao superintendente, a proposta de resposta é submetida à aprovação do GTPN."
    click ID_MPR_SAR_504_R00_0_10 href "#" "Após aprovação do GTPN, o documento contendo a resposta é encaminhado ao Superintendente para assinatura e posterior encaminhamento ao demandante."
```
