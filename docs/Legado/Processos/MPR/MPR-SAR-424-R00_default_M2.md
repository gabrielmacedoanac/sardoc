...
flowchart TD
    ...
    subgraph Container_ID_MPR_SAR_424_R00_0 [ ]
        direction TB
        ID_MPR_SAR_424_R00_0_Start((Início)):::inicio
        ID_MPR_SAR_424_R00_0_End(((Fim))):::fim
        subgraph Raia_ID_MPR_SAR_424_R00_0_1 [👤 GTPA - Coordenação KGD]
            ID_MPR_SAR_424_R00_0_01("<b>01. Solicitar informações para o KGD</b>"):::tarefaBPMN
            ID_MPR_SAR_424_R00_0_03("<b>03. Coletar Informações</b>"):::tarefaBPMN
            ID_MPR_SAR_424_R00_0_04("<b>04. Disponibilizar informações da SAR no KGD</b>"):::tarefaBPMN
        end
        class Raia_ID_MPR_SAR_424_R00_0_1 raia;
        subgraph Raia_ID_MPR_SAR_424_R00_0_2 [👤 SAR - Fornecedores KGD]
            ID_MPR_SAR_424_R00_0_02("<b>02. Fornecer dados para o KGD</b>"):::tarefaBPMN
        end
        class Raia_ID_MPR_SAR_424_R00_0_2 raia;
        subgraph Raia_ID_MPR_SAR_424_R00_0_3 [👤 GTPA - Visibilidade de Indicadores SAR]
            ID_MPR_SAR_424_R00_0_01("<b>01. Solicitar dados</b>"):::tarefaBPMN
            ID_MPR_SAR_424_R00_0_03("<b>03. Consolidar os dados recebidos</b>"):::tarefaBPMN
            ID_MPR_SAR_424_R00_0_04("<b>04. Emitir o relatório</b>"):::tarefaBPMN
        end
        class Raia_ID_MPR_SAR_424_R00_0_3 raia;
        subgraph Raia_ID_MPR_SAR_424_R00_0_4 [👤 SAR - Fornecedores de Indicadores de Visibilidade]
            ID_MPR_SAR_424_R00_0_02("<b>02. Fornecer dados de indicadores</b>"):::tarefaBPMN
        end
        class Raia_ID_MPR_SAR_424_R00_0_4 raia;
        ID_MPR_SAR_424_R00_0_Start --> ID_MPR_SAR_424_R00_0_01
        ID_MPR_SAR_424_R00_0_01 --> ID_MPR_SAR_424_R00_0_02
        ID_MPR_SAR_424_R00_0_02 --> ID_MPR_SAR_424_R00_0_03
        gw_ID_MPR_SAR_424_R00_0_03{"Dados estão completos?"}:::gatewayBPMN
        ID_MPR_SAR_424_R00_0_03 --> gw_ID_MPR_SAR_424_R00_0_03
        gw_ID_MPR_SAR_424_R00_0_03 -->|"sim, os dados estão completos"| ID_MPR_SAR_424_R00_0_04
        gw_ID_MPR_SAR_424_R00_0_03 -->|"não, os dados não estão completos"| ID_MPR_SAR_424_R00_0_01
        ID_MPR_SAR_424_R00_0_04 --> ID_MPR_SAR_424_R00_0_End
        ID_MPR_SAR_424_R00_0_01 --> ID_MPR_SAR_424_R00_0_02
        ID_MPR_SAR_424_R00_0_02 --> ID_MPR_SAR_424_R00_0_03
        gw_ID_MPR_SAR_424_R00_0_03{"Os dados estão completos?"}:::gatewayBPMN
        ID_MPR_SAR_424_R00_0_03 --> gw_ID_MPR_SAR_424_R00_0_03
        gw_ID_MPR_SAR_424_R00_0_03 -->|"sim, dados completos"| ID_MPR_SAR_424_R00_0_04
        gw_ID_MPR_SAR_424_R00_0_03 -->|"não, dados incompletos"| ID_MPR_SAR_424_R00_0_01
        ID_MPR_SAR_424_R00_0_04 --> ID_MPR_SAR_424_R00_0_End
    end
    click ID_MPR_SAR_424_R00_0_01 href "#" "Após o recebimento da demanda da SPI, que informa o prazo para o atendimento, inserir lembrete de acompanhamento para um dia útil antes do prazo estipulado.  Analisar se o mês atual exige relato mensal ou trimestral. Para os meses de março, junho, setembro e dezembro, o relato é trimestral.  Caso os dados sejam mensais, enviar E-Mail de Solicitação Mensal de Dados para o KGD, inserindo o lembrete de acompanhamento para dois dias úteis antes do prazo final.  Caso os dados sejam trimestrais, enviar E-Mail de Solicitação Trimestral de Dados para o KGD, inserindo o lembrete de acompanhamento para dois dias úteis antes do prazo final.  Para os casos de complementação de informações já solicitadas, enviar e-mail solicitando especificamente os dados incompletos."
    click ID_MPR_SAR_424_R00_0_02 href "#" "Fornecer os dados atualizados com as informações do mês, dentro do prazo estipulado."
    click ID_MPR_SAR_424_R00_0_03 href "#" "Criar pasta referente ao mês na rede da ANAC.  Copiar os arquivos com os dados recebidos e coletados na pasta criada.  Analisar se os dados estão completos."
    click ID_MPR_SAR_424_R00_0_04 href "#" "Disponibilizar os arquivos referentes ao mês conforme solicitado pela SPI, informando o que está sendo atualizado e a fonte de dados.  Enviar ao solicitante da SPI o E-Mail Informando que os Dados do KGD Foram Disponibilizados."
    click ID_MPR_SAR_424_R00_0_01 href "#" "No 1º dia útil do mês, enviar o E-Mail de Solicitação de Dados para a Visibilidade Mensal de Indicadores da SAR, aos fornecedores de indicadores de visibilidade, informando o prazo para o atendimento.  Para reenvio de solicitação, utilizada para casos de informações faltantes após o primeiro pedido, enviar e-mail ao fornecedor responsável, apontando o que deve ser acrescentado, corrigido ou alterado, solicitando o envio correto dos dados e informando um novo prazo para atendimento."
    click ID_MPR_SAR_424_R00_0_02 href "#" "Enviar, via e-mail, os dados pré acordados do mês anterior observando o prazo informado."
    click ID_MPR_SAR_424_R00_0_03 href "#" "Receber os dados, verificando se estão completos, e dispô-los no relatório, com os tratamentos necessários.  Avaliar se os dados do relatório estão completos."
    click ID_MPR_SAR_424_R00_0_04 href "#" "Atualizar o cabeçalho, rodapé e painel de controle.  Revisar a formatação final.  Salvar o arquivo na rede da ANAC.  Enviar o relatório ao GTPA para aprovação final e distribuição."
```
...
flowchart TD
    ...
    classDef gatewayBPMN fill:#f2f2f2,stroke:#333,stroke-width:1px;
    classDef raia fill:none,stroke:#999,stroke-width:1px,stroke-dasharray: 5 5;
    subgraph Container_ID_MPR_SAR_424_R00_1 [ ]
        direction TB
        ID_MPR_SAR_424_R00_1_Start((Início)):::inicio
        ID_MPR_SAR_424_R00_1_End(((Fim))):::fim
        subgraph Raia_ID_MPR_SAR_424_R00_1_1 [👤 GTPA - Visibilidade de Indicadores SAR]
            ID_MPR_SAR_424_R00_1_01("<b>01. Solicitar dados</b>"):::tarefaBPMN
            ID_MPR_SAR_424_R00_1_03("<b>03. Consolidar os dados recebidos</b>"):::tarefaBPMN
            ID_MPR_SAR_424_R00_1_04("<b>04. Emitir o relatório</b>"):::tarefaBPMN
        end
        class Raia_ID_MPR_SAR_424_R00_1_1 raia;
        subgraph Raia_ID_MPR_SAR_424_R00_1_2 [👤 SAR - Fornecedores de Indicadores de Visibilidade]
            ID_MPR_SAR_424_R00_1_02("<b>02. Fornecer dados de indicadores</b>"):::tarefaBPMN
        end
        class Raia_ID_MPR_SAR_424_R00_1_2 raia;
        ID_MPR_SAR_424_R00_1_Start --> ID_MPR_SAR_424_R00_1_01
        ID_MPR_SAR_424_R00_1_01 --> ID_MPR_SAR_424_R00_1_02
        ID_MPR_SAR_424_R00_1_02 --> ID_MPR_SAR_424_R00_1_03
        gw_ID_MPR_SAR_424_R00_1_03{"Os dados estão completos?"}:::gatewayBPMN
        ID_MPR_SAR_424_R00_1_03 --> gw_ID_MPR_SAR_424_R00_1_03
        gw_ID_MPR_SAR_424_R00_1_03 -->|"sim, dados completos"| ID_MPR_SAR_424_R00_1_04
        gw_ID_MPR_SAR_424_R00_1_03 -->|"não, dados incompletos"| ID_MPR_SAR_424_R00_1_01
        ID_MPR_SAR_424_R00_1_04 --> ID_MPR_SAR_424_R00_1_End
    end
    click ID_MPR_SAR_424_R00_1_01 href "#" "No 1º dia útil do mês, enviar o E-Mail de Solicitação de Dados para a Visibilidade Mensal de Indicadores da SAR, aos fornecedores de indicadores de visibilidade, informando o prazo para o atendimento.  Para reenvio de solicitação, utilizada para casos de informações faltantes após o primeiro pedido, enviar e-mail ao fornecedor responsável, apontando o que deve ser acrescentado, corrigido ou alterado, solicitando o envio correto dos dados e informando um novo prazo para atendimento."
    click ID_MPR_SAR_424_R00_1_02 href "#" "Enviar, via e-mail, os dados pré acordados do mês anterior observando o prazo informado."
    click ID_MPR_SAR_424_R00_1_03 href "#" "Receber os dados, verificando se estão completos, e dispô-los no relatório, com os tratamentos necessários.  Avaliar se os dados do relatório estão completos."
    click ID_MPR_SAR_424_R00_1_04 href "#" "Atualizar o cabeçalho, rodapé e painel de controle.  Revisar a formatação final.  Salvar o arquivo na rede da ANAC.  Enviar o relatório ao GTPA para aprovação final e distribuição."
```
