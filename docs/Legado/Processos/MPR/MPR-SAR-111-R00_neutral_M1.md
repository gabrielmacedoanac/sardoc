# MPR/SAR-111-R00 - INSPEÇÃO DE CONFORMIDADE DE PRODUTOS AERONÁUTICOS
...
flowchart TD
    ...
    subgraph Container_ID_MPR_SAR_111_R00_md_0 [ ]
        direction TB
        ID_MPR_SAR_111_R00_md_0_S((Início)):::inicio
        ID_MPR_SAR_111_R00_md_0_E(((Fim))):::fim
        ID_MPR_SAR_111_R00_md_0_01("<b>01. Analisar pedido</b><hr>Responsável: GTCO-CCIP - Coordenador de Equipe"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_02("<b>02. Escolher o executor da inspeção</b><hr>Responsável: GTCO-CCIP - Coordenador de Equipe"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_03("<b>03. Escalar equipe</b><hr>Responsável: GTCO-CCIP - Coordenador de Equipe"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_04("<b>04. (1) Analisar o processo</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_05("<b>05. Executar inspeção de conformidade</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_06("<b>06. Enviar resultado à Área Responsável</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_07("<b>07. Devolver à Área Responsável</b><hr>Responsável: GTCO-CCIP - Coordenador de Equipe"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_08("<b>08. (2) Analisar o processo</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_09("<b>09. Emitir AAPC</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_10("<b>10. Analisar resultado</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_11("<b>11. Devolver à Área Responsável</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_01("<b>01. Enviar resultado de conformidade ao orientador do credenciado</b><hr>Responsável: GTCO-CCIP - Coordenador de Equipe"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_02("<b>02. Analisar Resultado</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_03("<b>03. Encaminhar resultado para a área responsável</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_04("<b>04. Comunicar credenciado quanto a adequação do resultado da conformidade</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_0_S --> ID_MPR_SAR_111_R00_md_0_01
        gw_ID_MPR_SAR_111_R00_md_0_01{"Há erro formal ou técnico no PIC que demanda devolução para a Área Responsável?"}:::gatewayBPMN
        ID_MPR_SAR_111_R00_md_0_01 --> gw_ID_MPR_SAR_111_R00_md_0_01
        gw_ID_MPR_SAR_111_R00_md_0_01 -->|"sem erro"| ID_MPR_SAR_111_R00_md_0_02
        gw_ID_MPR_SAR_111_R00_md_0_01 -->|"com erro"| ID_MPR_SAR_111_R00_md_0_07
        gw_ID_MPR_SAR_111_R00_md_0_02{"Quem executará?"}:::gatewayBPMN
        ID_MPR_SAR_111_R00_md_0_02 --> gw_ID_MPR_SAR_111_R00_md_0_02
        gw_ID_MPR_SAR_111_R00_md_0_02 -->|"CCIP"| ID_MPR_SAR_111_R00_md_0_03
        gw_ID_MPR_SAR_111_R00_md_0_02 -->|"credenciado"| ID_MPR_SAR_111_R00_md_0_08
        ID_MPR_SAR_111_R00_md_0_03 --> ID_MPR_SAR_111_R00_md_0_04
        gw_ID_MPR_SAR_111_R00_md_0_04{"(1) O PIC está adequado ou é suficiente para prosseguir?"}:::gatewayBPMN
        ID_MPR_SAR_111_R00_md_0_04 --> gw_ID_MPR_SAR_111_R00_md_0_04
        gw_ID_MPR_SAR_111_R00_md_0_04 -->|"(1) Sim, está correto"| ID_MPR_SAR_111_R00_md_0_05
        gw_ID_MPR_SAR_111_R00_md_0_04 -->|"(1) Não está correto"| ID_MPR_SAR_111_R00_md_0_11
        ID_MPR_SAR_111_R00_md_0_05 --> ID_MPR_SAR_111_R00_md_0_06
        ID_MPR_SAR_111_R00_md_0_06 --> ID_MPR_SAR_111_R00_md_0_E
        ID_MPR_SAR_111_R00_md_0_07 --> ID_MPR_SAR_111_R00_md_0_E
        gw_ID_MPR_SAR_111_R00_md_0_08{"(2) O PIC está adequado ou é suficiente para prosseguir?"}:::gatewayBPMN
        ID_MPR_SAR_111_R00_md_0_08 --> gw_ID_MPR_SAR_111_R00_md_0_08
        gw_ID_MPR_SAR_111_R00_md_0_08 -->|"(2) Sim, está correto"| ID_MPR_SAR_111_R00_md_0_09
        gw_ID_MPR_SAR_111_R00_md_0_08 -->|"(2) Não está correto"| ID_MPR_SAR_111_R00_md_0_11
        ID_MPR_SAR_111_R00_md_0_09 --> ID_MPR_SAR_111_R00_md_0_10
        ID_MPR_SAR_111_R00_md_0_10 --> ID_MPR_SAR_111_R00_md_0_E
        ID_MPR_SAR_111_R00_md_0_11 --> ID_MPR_SAR_111_R00_md_0_E
        ID_MPR_SAR_111_R00_md_0_01 --> ID_MPR_SAR_111_R00_md_0_02
        gw_ID_MPR_SAR_111_R00_md_0_02{"O resultado está adequado?"}:::gatewayBPMN
        ID_MPR_SAR_111_R00_md_0_02 --> gw_ID_MPR_SAR_111_R00_md_0_02
        gw_ID_MPR_SAR_111_R00_md_0_02 -->|"não está adequado"| ID_MPR_SAR_111_R00_md_0_04
        gw_ID_MPR_SAR_111_R00_md_0_02 -->|"sim, está adequado"| ID_MPR_SAR_111_R00_md_0_03
        ID_MPR_SAR_111_R00_md_0_03 --> ID_MPR_SAR_111_R00_md_0_E
        ID_MPR_SAR_111_R00_md_0_04 --> ID_MPR_SAR_111_R00_md_0_02
    end
    click ID_MPR_SAR_111_R00_md_0_01 "Deve-se verificar se as instruções no PIC são suficientes para a execução da atividade. Exemplo: coerência, nível de detalhamento, também deve se verificar a cronologia das etapas de fabricação."
    click ID_MPR_SAR_111_R00_md_0_02 "Deve-se verificar qual aplicabilidade do caso. Havendo ou não interesse da GTCO na execução da conformidade, o coordenador deve registrar no andamento do processo (SEI) a ação que deverá ser executada.  Nesta etapa cabe ao Coordenador decidir quem executará a Inspeção dependendo da:  1. Disponibilid"
    click ID_MPR_SAR_111_R00_md_0_03 "O CCIP - Coordenador de Equipe deve verificar na planilha de escala utilizada pela equipe verificando a distribuição da carga de trabalho."
    click ID_MPR_SAR_111_R00_md_0_04 "O servidor, após receber o pedido de conformidade, faz uma análise preliminar dos documentos, deve verificar:  1. F-300-18 - Declaração de Conformidade - Statement Of Conformity;  2. O PIC - Pedido de Inspeção de Conformidade quanto a suficiência e coerência de dados, instruções (campo 8);  3. Verif"
    click ID_MPR_SAR_111_R00_md_0_05 "Após verificar a conveniência e oportunidade de inspetores da GTCO para a execução da inspeção de conformidade, o servidor processa a execução do pedido utilizando a ITD-111-01."
    click ID_MPR_SAR_111_R00_md_0_06 "Encaminha-se via SEI e deve se descrever no encaminhamento, caso haja, discrepâncias encontradas."
    click ID_MPR_SAR_111_R00_md_0_07 "O coordenador deve devolver o processo fazendo a atualização do andamento do processo no SEI."
    click ID_MPR_SAR_111_R00_md_0_08 "O servidor, após receber o pedido de conformidade, fará uma análise preliminar dos documentos, verificando os seguintes:  1. F-300-18 - Declaração de Conformidade - Statement Of Conformity;  2. PIC: quanto a suficiência e coerência de dados, e instruções (campo 8);  3. Desenhos;  4. Lista de peças; "
    click ID_MPR_SAR_111_R00_md_0_09 "Após a emissão da AAPC, o servidor que emitiu AAPC deve concluir o processo com o seguinte comentário no andamento “Emitida AAPC para um profissional credenciado executar a conformidade solicitada. Tendo em vista que o resultado reabrirá o pedido, concluo este”.  Deve se encerrar o processo no SEI. "
    click ID_MPR_SAR_111_R00_md_0_10 "Após receber o resultado faz-se checagem dos documentos segundo Processo de Trabalho Gerenciar Resultado de Pedido de Conformidade."
    click ID_MPR_SAR_111_R00_md_0_11 "Encaminha-se via SEI e deve se descrever no encaminhamento a inconsistência encontrada."
    click ID_MPR_SAR_111_R00_md_0_01 "O CCIP - Coordenador de Equipe faz uma análise preliminar do resultado que consiste em identificar quem é o orientador do PCF que executou a conformidade e verificar algum erro formal evidente. Também deve encaminhar para o orientador do credenciado que executou a conformidade ou algum outro servido"
    click ID_MPR_SAR_111_R00_md_0_02 "O servidor fará uma análise detalhada do resultado verificando se todos os requisitos formais e técnicos foram cumpridos, conforme o pedido (F-200-14 - Pedido de Conformidade). Deve se analisar:  1. F-300-18 - Declaração de Conformidade - Statement Of Conformity: pode se verificar se houve algum des"
    click ID_MPR_SAR_111_R00_md_0_03 "Após a análise do servidor encaminhar para a Área Responsável atualizando o andamento no SEI."
    click ID_MPR_SAR_111_R00_md_0_04 "o servidor (preferencialmente o orientador) envia uma comunicação ao profissional credenciado para que este corrija algum erro detectado no resultado da conformidade."
```
...
flowchart TD
    ...
    classDef gatewayBPMN fill:#f9f9f9,stroke:#333,stroke-width:1px;
    classDef raia fill:none,stroke:#999,stroke-width:1px,stroke-dasharray: 5 5;
    subgraph Container_ID_MPR_SAR_111_R00_md_1 [ ]
        direction TB
        ID_MPR_SAR_111_R00_md_1_S((Início)):::inicio
        ID_MPR_SAR_111_R00_md_1_E(((Fim))):::fim
        ID_MPR_SAR_111_R00_md_1_01("<b>01. Enviar resultado de conformidade ao orientador do credenciado</b><hr>Responsável: GTCO-CCIP - Coordenador de Equipe"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_1_02("<b>02. Analisar Resultado</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_1_03("<b>03. Encaminhar resultado para a área responsável</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_1_04("<b>04. Comunicar credenciado quanto a adequação do resultado da conformidade</b><hr>Responsável: CCIP"):::tarefaBPMN
        ID_MPR_SAR_111_R00_md_1_S --> ID_MPR_SAR_111_R00_md_1_01
        ID_MPR_SAR_111_R00_md_1_01 --> ID_MPR_SAR_111_R00_md_1_02
        gw_ID_MPR_SAR_111_R00_md_1_02{"O resultado está adequado?"}:::gatewayBPMN
        ID_MPR_SAR_111_R00_md_1_02 --> gw_ID_MPR_SAR_111_R00_md_1_02
        gw_ID_MPR_SAR_111_R00_md_1_02 -->|"não está adequado"| ID_MPR_SAR_111_R00_md_1_04
        gw_ID_MPR_SAR_111_R00_md_1_02 -->|"sim, está adequado"| ID_MPR_SAR_111_R00_md_1_03
        ID_MPR_SAR_111_R00_md_1_03 --> ID_MPR_SAR_111_R00_md_1_E
        ID_MPR_SAR_111_R00_md_1_04 --> ID_MPR_SAR_111_R00_md_1_02
    end
    click ID_MPR_SAR_111_R00_md_1_01 "O CCIP - Coordenador de Equipe faz uma análise preliminar do resultado que consiste em identificar quem é o orientador do PCF que executou a conformidade e verificar algum erro formal evidente. Também deve encaminhar para o orientador do credenciado que executou a conformidade ou algum outro servido"
    click ID_MPR_SAR_111_R00_md_1_02 "O servidor fará uma análise detalhada do resultado verificando se todos os requisitos formais e técnicos foram cumpridos, conforme o pedido (F-200-14 - Pedido de Conformidade). Deve se analisar:  1. F-300-18 - Declaração de Conformidade - Statement Of Conformity: pode se verificar se houve algum des"
    click ID_MPR_SAR_111_R00_md_1_03 "Após a análise do servidor encaminhar para a Área Responsável atualizando o andamento no SEI."
    click ID_MPR_SAR_111_R00_md_1_04 "o servidor (preferencialmente o orientador) envia uma comunicação ao profissional credenciado para que este corrija algum erro detectado no resultado da conformidade."
```
