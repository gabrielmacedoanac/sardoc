...
flowchart TD
    ...
    classDef gatewayBPMN fill:#ececec,stroke:#333,stroke-width:1px;
    classDef raia fill:none,stroke:#999,stroke-width:1px,stroke-dasharray: 5 5;
    subgraph Container_ID_MPR_SAR_221_R02_6 [ ]
        direction TB
        ID_MPR_SAR_221_R02_6_Start((Início)):::inicio
        ID_MPR_SAR_221_R02_6_End(((Fim))):::fim
        ID_MPR_SAR_221_R02_6_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_6_02("<b>02. Elaborar ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_6_03("<b>03. Elaborar Portaria para publicação no DOU</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_6_01("<b>01. Analisar a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_6_02("<b>02. Realizar auditoria</b><hr>Responsável: GTCO - Equipe Auditora."):::tarefaBPMN
        ID_MPR_SAR_221_R02_6_03("<b>03. Deliberar sobre a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_6_Start --> ID_MPR_SAR_221_R02_6_01
        ID_MPR_SAR_221_R02_6_01 --> ID_MPR_SAR_221_R02_6_02
        ID_MPR_SAR_221_R02_6_02 --> ID_MPR_SAR_221_R02_6_03
        ID_MPR_SAR_221_R02_6_03 --> ID_MPR_SAR_221_R02_6_End
        gw_ID_MPR_SAR_221_R02_6_01{"É necessário verificar a alteração em auditoria?"}:::gatewayBPMN
        ID_MPR_SAR_221_R02_6_01 --> gw_ID_MPR_SAR_221_R02_6_01
        gw_ID_MPR_SAR_221_R02_6_01 -->|"NÃO, não é necessário verificar em auditoria"| ID_MPR_SAR_221_R02_6_03
        gw_ID_MPR_SAR_221_R02_6_01 -->|"sim, é necessário verificar em auditoria"| ID_MPR_SAR_221_R02_6_02
        ID_MPR_SAR_221_R02_6_02 --> ID_MPR_SAR_221_R02_6_03
        ID_MPR_SAR_221_R02_6_03 --> ID_MPR_SAR_221_R02_6_End
    end
    click ID_MPR_SAR_221_R02_6_01 href "#" "O GTCO - CP deve analisar se a pessoa que assinou o requerimento para cancelamento do COP tem autorização para representar a empresa. Se for necessário, o GTCO - CP deve solicitar cópia do contrato social e procuração."
    click ID_MPR_SAR_221_R02_6_02 href "#" "O GTCO - CP deve elaborar ofício informando à empresa sobre o cancelamento do COP, como foi solicitado, e encaminhar o ofício para assinatura.  O GTCO - CP deve atualizar o status do COP na Intranet da SAR."
    click ID_MPR_SAR_221_R02_6_03 href "#" "O GTCO - CP deve elaborar uma portaria para dar publicidade ao cancelamento do COP. Esta atividade possui como artefato um modelo de portaria que pode ser utilizado."
    click ID_MPR_SAR_221_R02_6_01 href "#" "O detentor de um COP deve comunicar à ANAC, por escrito, qualquer alteração em seu sistema da qualidade ou na localização das instalações de fabricação que possam afetar inspeção, conformidade ou aeronavegabilidade.  Ao receber a notificação, o coordenador de produção deve verificar se os requisitos do RBAC 21 continuam sendo atendidos, utilizando o formulário F-300-28 – Questionário de avaliação de sistemas da qualidade, como referência.  Caso o GTCO - CP conclua que após a alteração o detentor do COP deixou de atender aos requisitos do RBAC 21, deve proceder diretamente para a etapa 3, de registro da análise.  Caso o GTCO - CP conclua que os requisitos continuam sendo atendidos, deve decidir se é necessária a realização de uma auditoria específica para avaliar a alteração, ou se a avaliação pode ser realizada na próxima auditoria agendada na empresa. Essa decisão é subjetiva e depende do conhecimento do GTCO - CP sobre o sistema da qualidade da empresa, considerando:  1. Se há alguma auditoria agendada para a empresa  2. Se o sistema da qualidade da empresa possui meios para gerir a alteração (ex. qualificação de processo, FAI, Try-Out, etc)  3. Se a localização de localização de algum processo especial ou crítico foi realizada.  O GTCO - CP deve elaborar um parecer para registrar a avaliação da necessidade de auditoria.  Caso a auditoria imediata seja necessária, o GTCO - CP deve encaminhar o processo com o parecer para o coordenador do grupo de produção para preparação de auditoria não programada.  Caso a verificação sobre a alteração possa ser realizada na próxima auditoria programada, o GTCO - CP deve manter registro da alteração para informar ao auditor líder no momento de elaboração do programa de auditoria."
    click ID_MPR_SAR_221_R02_6_02 href "#" "O GTCOCPROD definirá equipe e data para a realização da auditoria não programada para verificação da alteração no sistema da qualidade proposta.  Será gerado um novo processo no SEI, associado ao processo da comunicação da alteração, para a realização da auditoria. O processo de comunicação da modificação será devolvido para o GTCO - CP para acompanhamento.  Não é necessário o envio do programa de auditoria nem recolhimento de TFAC. O GTCO - CP explicará ao Auditor Líder o que é necessário verificar na auditoria não programada. As demais atividades da ITD-121-01 devem ser seguidas.  Caso sejam identificadas não conformidades, o Auditor Líder deve elaborar um relatório de auditoria e adotar as providências administrativas apropriadas.  Após a realização da auditoria, o Auditor Líder deve inserir no processo um parecer sobre o atendimento aos requisitos em relação às verificações solicitadas pelo GTCO - CP."
    click ID_MPR_SAR_221_R02_6_03 href "#" "O GTCO - CP deve elaborar um parecer contendo o resultado da análise (se o detentor do COP continua cumprindo com os requisitos do RBAC 21 ou se deixou de cumprir com algum requisito).  Caso o GTCO - CP conclua que após a alteração o detentor do COP deixou de atender aos requisitos do RBAC 21, deve elaborar um ofício solicitando que a empresa desfaça a alteração, retornando o sistema da qualidade à condição da certificação. O GTCO - CP deve, então, encaminhar o ofício para assinatura do GTCO."
```
...
flowchart TD
    ...
    classDef gatewayBPMN fill:#ececec,stroke:#333,stroke-width:1px;
    classDef raia fill:none,stroke:#999,stroke-width:1px,stroke-dasharray: 5 5;
    subgraph Container_ID_MPR_SAR_221_R02_5 [ ]
        direction TB
        ID_MPR_SAR_221_R02_5_Start((Início)):::inicio
        ID_MPR_SAR_221_R02_5_End(((Fim))):::fim
        ID_MPR_SAR_221_R02_5_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_5_02("<b>02. Analisar Manual da Qualidade</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_5_03("<b>03. Elaborar Ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_5_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_5_02("<b>02. Elaborar ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_5_03("<b>03. Elaborar Portaria para publicação no DOU</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_5_01("<b>01. Analisar a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_5_02("<b>02. Realizar auditoria</b><hr>Responsável: GTCO - Equipe Auditora."):::tarefaBPMN
        ID_MPR_SAR_221_R02_5_03("<b>03. Deliberar sobre a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_5_Start --> ID_MPR_SAR_221_R02_5_01
        ID_MPR_SAR_221_R02_5_01 --> ID_MPR_SAR_221_R02_5_02
        ID_MPR_SAR_221_R02_5_02 --> ID_MPR_SAR_221_R02_5_03
        ID_MPR_SAR_221_R02_5_03 --> ID_MPR_SAR_221_R02_5_End
        ID_MPR_SAR_221_R02_5_01 --> ID_MPR_SAR_221_R02_5_02
        ID_MPR_SAR_221_R02_5_02 --> ID_MPR_SAR_221_R02_5_03
        ID_MPR_SAR_221_R02_5_03 --> ID_MPR_SAR_221_R02_5_End
        gw_ID_MPR_SAR_221_R02_5_01{"É necessário verificar a alteração em auditoria?"}:::gatewayBPMN
        ID_MPR_SAR_221_R02_5_01 --> gw_ID_MPR_SAR_221_R02_5_01
        gw_ID_MPR_SAR_221_R02_5_01 -->|"NÃO, não é necessário verificar em auditoria"| ID_MPR_SAR_221_R02_5_03
        gw_ID_MPR_SAR_221_R02_5_01 -->|"sim, é necessário verificar em auditoria"| ID_MPR_SAR_221_R02_5_02
        ID_MPR_SAR_221_R02_5_02 --> ID_MPR_SAR_221_R02_5_03
        ID_MPR_SAR_221_R02_5_03 --> ID_MPR_SAR_221_R02_5_End
    end
    click ID_MPR_SAR_221_R02_5_01 href "#" "O GTCO - CP deve analisar se o requerente enviou o comprovante de pagamento da TFAC relacionada à revisão do manual da qualidade, conforme ITD 121-03."
    click ID_MPR_SAR_221_R02_5_02 href "#" "As seções 21.138, 21.308 e 21.608 requerem que a ANAC aprove o manual da qualidade do requerente ou detentor de um COP. Revisões do manual da qualidade também devem ser aprovadas.  Ao receber uma proposta de alteração do manual da qualidade, o coordenador de produção deve verificar se os requisitos do RBAC 21 continuam sendo atendidos, utilizando o formulário F-300-28 – Questionário de avaliação de sistemas da qualidade, como referência.  O GTCO - CP deve inserir no processo um parecer contendo o resultado da análise."
    click ID_MPR_SAR_221_R02_5_03 href "#" "O GTCO - CP deve elaborar um ofício contendo o resultado da análise, aprovando ou não o manual da qualidade e encaminhar o ofício para assinatura do GTCO."
    click ID_MPR_SAR_221_R02_5_01 href "#" "O GTCO - CP deve analisar se a pessoa que assinou o requerimento para cancelamento do COP tem autorização para representar a empresa. Se for necessário, o GTCO - CP deve solicitar cópia do contrato social e procuração."
    click ID_MPR_SAR_221_R02_5_02 href "#" "O GTCO - CP deve elaborar ofício informando à empresa sobre o cancelamento do COP, como foi solicitado, e encaminhar o ofício para assinatura.  O GTCO - CP deve atualizar o status do COP na Intranet da SAR."
    click ID_MPR_SAR_221_R02_5_03 href "#" "O GTCO - CP deve elaborar uma portaria para dar publicidade ao cancelamento do COP. Esta atividade possui como artefato um modelo de portaria que pode ser utilizado."
    click ID_MPR_SAR_221_R02_5_01 href "#" "O detentor de um COP deve comunicar à ANAC, por escrito, qualquer alteração em seu sistema da qualidade ou na localização das instalações de fabricação que possam afetar inspeção, conformidade ou aeronavegabilidade.  Ao receber a notificação, o coordenador de produção deve verificar se os requisitos do RBAC 21 continuam sendo atendidos, utilizando o formulário F-300-28 – Questionário de avaliação de sistemas da qualidade, como referência.  Caso o GTCO - CP conclua que após a alteração o detentor do COP deixou de atender aos requisitos do RBAC 21, deve proceder diretamente para a etapa 3, de registro da análise.  Caso o GTCO - CP conclua que os requisitos continuam sendo atendidos, deve decidir se é necessária a realização de uma auditoria específica para avaliar a alteração, ou se a avaliação pode ser realizada na próxima auditoria agendada na empresa. Essa decisão é subjetiva e depende do conhecimento do GTCO - CP sobre o sistema da qualidade da empresa, considerando:  1. Se há alguma auditoria agendada para a empresa  2. Se o sistema da qualidade da empresa possui meios para gerir a alteração (ex. qualificação de processo, FAI, Try-Out, etc)  3. Se a localização de localização de algum processo especial ou crítico foi realizada.  O GTCO - CP deve elaborar um parecer para registrar a avaliação da necessidade de auditoria.  Caso a auditoria imediata seja necessária, o GTCO - CP deve encaminhar o processo com o parecer para o coordenador do grupo de produção para preparação de auditoria não programada.  Caso a verificação sobre a alteração possa ser realizada na próxima auditoria programada, o GTCO - CP deve manter registro da alteração para informar ao auditor líder no momento de elaboração do programa de auditoria."
    click ID_MPR_SAR_221_R02_5_02 href "#" "O GTCOCPROD definirá equipe e data para a realização da auditoria não programada para verificação da alteração no sistema da qualidade proposta.  Será gerado um novo processo no SEI, associado ao processo da comunicação da alteração, para a realização da auditoria. O processo de comunicação da modificação será devolvido para o GTCO - CP para acompanhamento.  Não é necessário o envio do programa de auditoria nem recolhimento de TFAC. O GTCO - CP explicará ao Auditor Líder o que é necessário verificar na auditoria não programada. As demais atividades da ITD-121-01 devem ser seguidas.  Caso sejam identificadas não conformidades, o Auditor Líder deve elaborar um relatório de auditoria e adotar as providências administrativas apropriadas.  Após a realização da auditoria, o Auditor Líder deve inserir no processo um parecer sobre o atendimento aos requisitos em relação às verificações solicitadas pelo GTCO - CP."
    click ID_MPR_SAR_221_R02_5_03 href "#" "O GTCO - CP deve elaborar um parecer contendo o resultado da análise (se o detentor do COP continua cumprindo com os requisitos do RBAC 21 ou se deixou de cumprir com algum requisito).  Caso o GTCO - CP conclua que após a alteração o detentor do COP deixou de atender aos requisitos do RBAC 21, deve elaborar um ofício solicitando que a empresa desfaça a alteração, retornando o sistema da qualidade à condição da certificação. O GTCO - CP deve, então, encaminhar o ofício para assinatura do GTCO."
```
...
flowchart TD
    ...
    classDef gatewayBPMN fill:#ececec,stroke:#333,stroke-width:1px;
    classDef raia fill:none,stroke:#999,stroke-width:1px,stroke-dasharray: 5 5;
    subgraph Container_ID_MPR_SAR_221_R02_4 [ ]
        direction TB
        ID_MPR_SAR_221_R02_4_Start((Início)):::inicio
        ID_MPR_SAR_221_R02_4_End(((Fim))):::fim
        ID_MPR_SAR_221_R02_4_01("<b>01. Elaborar nota técnica</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_02("<b>02. Elaborar ofício e portaria</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_03("<b>03. Assinar documentos de adoção de medida cautelar</b><hr>Responsável: O Gtco."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_04("<b>04. Acompanhar a implementação das providências</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_05("<b>05. Revogar o COP</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_06("<b>06. Revogar a medida cautelar</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_07("<b>07. Assinar documentos</b><hr>Responsável: O Gtco."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_02("<b>02. Analisar Manual da Qualidade</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_03("<b>03. Elaborar Ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_02("<b>02. Elaborar ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_03("<b>03. Elaborar Portaria para publicação no DOU</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_01("<b>01. Analisar a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_02("<b>02. Realizar auditoria</b><hr>Responsável: GTCO - Equipe Auditora."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_03("<b>03. Deliberar sobre a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_4_Start --> ID_MPR_SAR_221_R02_4_01
        ID_MPR_SAR_221_R02_4_01 --> ID_MPR_SAR_221_R02_4_02
        ID_MPR_SAR_221_R02_4_02 --> ID_MPR_SAR_221_R02_4_03
        ID_MPR_SAR_221_R02_4_03 --> ID_MPR_SAR_221_R02_4_04
        gw_ID_MPR_SAR_221_R02_4_04{"É necessário revogar o COP?"}:::gatewayBPMN
        ID_MPR_SAR_221_R02_4_04 --> gw_ID_MPR_SAR_221_R02_4_04
        gw_ID_MPR_SAR_221_R02_4_04 -->|"sim, o regulado não adotou as providências necessárias"| ID_MPR_SAR_221_R02_4_05
        gw_ID_MPR_SAR_221_R02_4_04 -->|"não, o regulado implementou as providências necessárias"| ID_MPR_SAR_221_R02_4_06
        ID_MPR_SAR_221_R02_4_05 --> ID_MPR_SAR_221_R02_4_07
        ID_MPR_SAR_221_R02_4_06 --> ID_MPR_SAR_221_R02_4_07
        ID_MPR_SAR_221_R02_4_07 --> ID_MPR_SAR_221_R02_4_End
        ID_MPR_SAR_221_R02_4_01 --> ID_MPR_SAR_221_R02_4_02
        ID_MPR_SAR_221_R02_4_02 --> ID_MPR_SAR_221_R02_4_03
        ID_MPR_SAR_221_R02_4_03 --> ID_MPR_SAR_221_R02_4_End
        ID_MPR_SAR_221_R02_4_01 --> ID_MPR_SAR_221_R02_4_02
        ID_MPR_SAR_221_R02_4_02 --> ID_MPR_SAR_221_R02_4_03
        ID_MPR_SAR_221_R02_4_03 --> ID_MPR_SAR_221_R02_4_End
        gw_ID_MPR_SAR_221_R02_4_01{"É necessário verificar a alteração em auditoria?"}:::gatewayBPMN
        ID_MPR_SAR_221_R02_4_01 --> gw_ID_MPR_SAR_221_R02_4_01
        gw_ID_MPR_SAR_221_R02_4_01 -->|"NÃO, não é necessário verificar em auditoria"| ID_MPR_SAR_221_R02_4_03
        gw_ID_MPR_SAR_221_R02_4_01 -->|"sim, é necessário verificar em auditoria"| ID_MPR_SAR_221_R02_4_02
        ID_MPR_SAR_221_R02_4_02 --> ID_MPR_SAR_221_R02_4_03
        ID_MPR_SAR_221_R02_4_03 --> ID_MPR_SAR_221_R02_4_End
    end
    click ID_MPR_SAR_221_R02_4_01 href "#" "Ao identificar situação ou conduta que gere risco iminente à segurança de voo, à integridade física de pessoas, à coletividade, à ordem pública, à continuidade dos serviços prestados ou ao interesse público, o agente da ANAC no exercício de atividade de fiscalização deverá atuar de acordo com os artigos 57 a 60 da resolução 472.  A motivação para a suspensão cautelar deve ser registrada em uma nota técnica em um novo processo no SEI relacionado ao processo de fiscalização em andamento. A nota técnica deve conter no mínimo:  • Resumo da atividade de fiscalização através da qual foi identificada a necessidade de adoção da medida cautelar;  • Razão pela qual a situação identificada pode gerar risco iminente à segurança de voo, à integridade física de pessoas, à coletividade, à ordem pública, à continuidade dos serviços prestados ou ao interesse público;  • Quais medidas, corretivas ou mitigatórias, são esperadas para a revogação da suspensão cautelar.  Dependendo da situação encontrada durante atividade de fiscalização externa, a suspensão cautelar pode ser adotada imediatamente e notificada ao acautelado. A notificação deve ser assinada pelo acautelado e deve possuir o conteúdo estabelecido no Art. 58 da resolução 472.  Em caso de recusa do acautelado em assinar a notificação da medida acautelatória, a assinatura do servidor, acompanhada de uma anotação sobre o fato, suprirá a ciência do acautelado, conforme parágrafo 1º do Art. 58 da resolução 472/2018.  Neste caso, o auditor líder deve dar ciência à chefia imediata por telefone e a nota técnica deve ser elaborada após o retorno à sede, para documentar a ocorrência.  Quando for possível, é preferível que a medida seja adotada após o retorno do agente à sede, para que a documentação da situação e a ciência à chefia imediata ocorram antes da notificação ao acautelado.  A nota técnica deve ser assinada pelo(s) agente(s) que identificou(aram) a situação de risco e encaminhada, por e-mail dentro do processo SEI, para ciência do GTCO e do SAR."
    click ID_MPR_SAR_221_R02_4_02 href "#" "O agente que identificou a situação de risco deve elaborar um ofício para notificar o acautelado. De acordo com o artigo 58 da resolução 472/2018, o ofício deve conter no mínimo:  • A infração identificada, com a sua fundamentação;  • Documentos e providências necessárias para revogação da medida acautelatória;  • Identificação do acautelado e unidade responsável pela medida.  O agente deve, ainda, elaborar portaria para publicação da suspensão cautelar no diário oficial e um despacho para envio da portaria para a ASCOM.  O ofício deve ser encaminhado para assinatura do GTCO e envio ao acautelado (com AR).  A portaria e o despacho devem ser encaminhados para assinatura do GTCO e envio para a ASCOM para publicação no DOU."
    click ID_MPR_SAR_221_R02_4_03 href "#" "O GTCO deve assinar o ofício de notificação da medida cautelar, a portaria para publicação no DOU e o despacho de encaminhamento da portaria para a ASCOM."
    click ID_MPR_SAR_221_R02_4_04 href "#" "O agente que identificou a situação de risco deve acompanhar a implementação das providências necessárias para revogação da medida cautelar, conforme informado na notificação ao acautelado.  O acompanhamento deve ser registrado na Intranet da SAR, em um relatório de acompanhamento.  Caso o acautelado não se manifeste no prazo de 90 dias, o agente deve encaminhar novo ofício, com AR, solicitando a adoção das providências necessárias no prazo de 90 dias adicionais.  Caso o acautelado não se manifeste, decorridos os 180 dias, o agente deve encaminhar ofício informando que o COP será revogado caso não haja manifestação em 20 dias."
    click ID_MPR_SAR_221_R02_4_05 href "#" "Caso o acautelado não atenda aos prazos para manifestação e adoção das providências necessárias para revogação da medida cautelar, o COP deve ser revogado.  O agente que identificou a situação de risco deve elaborar um ofício para notificar o acautelado sobre a revogação do COP.  O agente deve, ainda, elaborar portaria para publicação da revogação do COP no diário oficial, e um despacho para envio da portaria para a ASCOM.  O ofício deve ser encaminhado para assinatura do GTCO e envio ao acautelado.  A portaria e o despacho devem ser encaminhados para assinatura do GTCO e envio para a ASCOM para publicação no DOU."
    click ID_MPR_SAR_221_R02_4_06 href "#" "Caso o acautelado adote as providências necessárias, a medida cautelar deve ser revogada.  O agente que identificou a situação de risco deve elaborar um ofício para notificar o acautelado sobre a revogação da medida cautelar.  O agente deve, ainda, elaborar portaria para publicação da revogação da medida cautelar no diário oficial, e um despacho para envio da portaria para a ASCOM.  O ofício deve ser encaminhado para assinatura do GTCO e envio ao acautelado.  A portaria e o despacho devem ser encaminhados para assinatura do GTCO e envio para a ASCOM para publicação no DOU."
    click ID_MPR_SAR_221_R02_4_07 href "#" "O GTCO deve assinar o ofício de notificação da revogação do COP ou da medida cautelar, a portaria para publicação no DOU e o despacho de encaminhamento da portaria para a ASCOM."
    click ID_MPR_SAR_221_R02_4_01 href "#" "O GTCO - CP deve analisar se o requerente enviou o comprovante de pagamento da TFAC relacionada à revisão do manual da qualidade, conforme ITD 121-03."
    click ID_MPR_SAR_221_R02_4_02 href "#" "As seções 21.138, 21.308 e 21.608 requerem que a ANAC aprove o manual da qualidade do requerente ou detentor de um COP. Revisões do manual da qualidade também devem ser aprovadas.  Ao receber uma proposta de alteração do manual da qualidade, o coordenador de produção deve verificar se os requisitos do RBAC 21 continuam sendo atendidos, utilizando o formulário F-300-28 – Questionário de avaliação de sistemas da qualidade, como referência.  O GTCO - CP deve inserir no processo um parecer contendo o resultado da análise."
    click ID_MPR_SAR_221_R02_4_03 href "#" "O GTCO - CP deve elaborar um ofício contendo o resultado da análise, aprovando ou não o manual da qualidade e encaminhar o ofício para assinatura do GTCO."
    click ID_MPR_SAR_221_R02_4_01 href "#" "O GTCO - CP deve analisar se a pessoa que assinou o requerimento para cancelamento do COP tem autorização para representar a empresa. Se for necessário, o GTCO - CP deve solicitar cópia do contrato social e procuração."
    click ID_MPR_SAR_221_R02_4_02 href "#" "O GTCO - CP deve elaborar ofício informando à empresa sobre o cancelamento do COP, como foi solicitado, e encaminhar o ofício para assinatura.  O GTCO - CP deve atualizar o status do COP na Intranet da SAR."
    click ID_MPR_SAR_221_R02_4_03 href "#" "O GTCO - CP deve elaborar uma portaria para dar publicidade ao cancelamento do COP. Esta atividade possui como artefato um modelo de portaria que pode ser utilizado."
    click ID_MPR_SAR_221_R02_4_01 href "#" "O detentor de um COP deve comunicar à ANAC, por escrito, qualquer alteração em seu sistema da qualidade ou na localização das instalações de fabricação que possam afetar inspeção, conformidade ou aeronavegabilidade.  Ao receber a notificação, o coordenador de produção deve verificar se os requisitos do RBAC 21 continuam sendo atendidos, utilizando o formulário F-300-28 – Questionário de avaliação de sistemas da qualidade, como referência.  Caso o GTCO - CP conclua que após a alteração o detentor do COP deixou de atender aos requisitos do RBAC 21, deve proceder diretamente para a etapa 3, de registro da análise.  Caso o GTCO - CP conclua que os requisitos continuam sendo atendidos, deve decidir se é necessária a realização de uma auditoria específica para avaliar a alteração, ou se a avaliação pode ser realizada na próxima auditoria agendada na empresa. Essa decisão é subjetiva e depende do conhecimento do GTCO - CP sobre o sistema da qualidade da empresa, considerando:  1. Se há alguma auditoria agendada para a empresa  2. Se o sistema da qualidade da empresa possui meios para gerir a alteração (ex. qualificação de processo, FAI, Try-Out, etc)  3. Se a localização de localização de algum processo especial ou crítico foi realizada.  O GTCO - CP deve elaborar um parecer para registrar a avaliação da necessidade de auditoria.  Caso a auditoria imediata seja necessária, o GTCO - CP deve encaminhar o processo com o parecer para o coordenador do grupo de produção para preparação de auditoria não programada.  Caso a verificação sobre a alteração possa ser realizada na próxima auditoria programada, o GTCO - CP deve manter registro da alteração para informar ao auditor líder no momento de elaboração do programa de auditoria."
    click ID_MPR_SAR_221_R02_4_02 href "#" "O GTCOCPROD definirá equipe e data para a realização da auditoria não programada para verificação da alteração no sistema da qualidade proposta.  Será gerado um novo processo no SEI, associado ao processo da comunicação da alteração, para a realização da auditoria. O processo de comunicação da modificação será devolvido para o GTCO - CP para acompanhamento.  Não é necessário o envio do programa de auditoria nem recolhimento de TFAC. O GTCO - CP explicará ao Auditor Líder o que é necessário verificar na auditoria não programada. As demais atividades da ITD-121-01 devem ser seguidas.  Caso sejam identificadas não conformidades, o Auditor Líder deve elaborar um relatório de auditoria e adotar as providências administrativas apropriadas.  Após a realização da auditoria, o Auditor Líder deve inserir no processo um parecer sobre o atendimento aos requisitos em relação às verificações solicitadas pelo GTCO - CP."
    click ID_MPR_SAR_221_R02_4_03 href "#" "O GTCO - CP deve elaborar um parecer contendo o resultado da análise (se o detentor do COP continua cumprindo com os requisitos do RBAC 21 ou se deixou de cumprir com algum requisito).  Caso o GTCO - CP conclua que após a alteração o detentor do COP deixou de atender aos requisitos do RBAC 21, deve elaborar um ofício solicitando que a empresa desfaça a alteração, retornando o sistema da qualidade à condição da certificação. O GTCO - CP deve, então, encaminhar o ofício para assinatura do GTCO."
```
...
flowchart TD
    ...
    classDef gatewayBPMN fill:#ececec,stroke:#333,stroke-width:1px;
    classDef raia fill:none,stroke:#999,stroke-width:1px,stroke-dasharray: 5 5;
    subgraph Container_ID_MPR_SAR_221_R02_3 [ ]
        direction TB
        ID_MPR_SAR_221_R02_3_Start((Início)):::inicio
        ID_MPR_SAR_221_R02_3_End(((Fim))):::fim
        ID_MPR_SAR_221_R02_3_01("<b>01. Realizar o voo de produção</b><hr>Responsável: Coordenadoria de Aeronáutica, Ensaios em Voo e Integração de Sistemas."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_02("<b>02. Analisar relatório de voo de produção</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_01("<b>01. Elaborar nota técnica</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_02("<b>02. Elaborar ofício e portaria</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_03("<b>03. Assinar documentos de adoção de medida cautelar</b><hr>Responsável: O Gtco."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_04("<b>04. Acompanhar a implementação das providências</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_05("<b>05. Revogar o COP</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_06("<b>06. Revogar a medida cautelar</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_07("<b>07. Assinar documentos</b><hr>Responsável: O Gtco."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_02("<b>02. Analisar Manual da Qualidade</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_03("<b>03. Elaborar Ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_02("<b>02. Elaborar ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_03("<b>03. Elaborar Portaria para publicação no DOU</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_01("<b>01. Analisar a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_02("<b>02. Realizar auditoria</b><hr>Responsável: GTCO - Equipe Auditora."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_03("<b>03. Deliberar sobre a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_3_Start --> ID_MPR_SAR_221_R02_3_01
        ID_MPR_SAR_221_R02_3_01 --> ID_MPR_SAR_221_R02_3_02
        ID_MPR_SAR_221_R02_3_02 --> ID_MPR_SAR_221_R02_3_End
        ID_MPR_SAR_221_R02_3_01 --> ID_MPR_SAR_221_R02_3_02
        ID_MPR_SAR_221_R02_3_02 --> ID_MPR_SAR_221_R02_3_03
        ID_MPR_SAR_221_R02_3_03 --> ID_MPR_SAR_221_R02_3_04
        gw_ID_MPR_SAR_221_R02_3_04{"É necessário revogar o COP?"}:::gatewayBPMN
        ID_MPR_SAR_221_R02_3_04 --> gw_ID_MPR_SAR_221_R02_3_04
        gw_ID_MPR_SAR_221_R02_3_04 -->|"sim, o regulado não adotou as providências necessárias"| ID_MPR_SAR_221_R02_3_05
        gw_ID_MPR_SAR_221_R02_3_04 -->|"não, o regulado implementou as providências necessárias"| ID_MPR_SAR_221_R02_3_06
        ID_MPR_SAR_221_R02_3_05 --> ID_MPR_SAR_221_R02_3_07
        ID_MPR_SAR_221_R02_3_06 --> ID_MPR_SAR_221_R02_3_07
        ID_MPR_SAR_221_R02_3_07 --> ID_MPR_SAR_221_R02_3_End
        ID_MPR_SAR_221_R02_3_01 --> ID_MPR_SAR_221_R02_3_02
        ID_MPR_SAR_221_R02_3_02 --> ID_MPR_SAR_221_R02_3_03
        ID_MPR_SAR_221_R02_3_03 --> ID_MPR_SAR_221_R02_3_End
        ID_MPR_SAR_221_R02_3_01 --> ID_MPR_SAR_221_R02_3_02
        ID_MPR_SAR_221_R02_3_02 --> ID_MPR_SAR_221_R02_3_03
        ID_MPR_SAR_221_R02_3_03 --> ID_MPR_SAR_221_R02_3_End
        gw_ID_MPR_SAR_221_R02_3_01{"É necessário verificar a alteração em auditoria?"}:::gatewayBPMN
        ID_MPR_SAR_221_R02_3_01 --> gw_ID_MPR_SAR_221_R02_3_01
        gw_ID_MPR_SAR_221_R02_3_01 -->|"NÃO, não é necessário verificar em auditoria"| ID_MPR_SAR_221_R02_3_03
        gw_ID_MPR_SAR_221_R02_3_01 -->|"sim, é necessário verificar em auditoria"| ID_MPR_SAR_221_R02_3_02
        ID_MPR_SAR_221_R02_3_02 --> ID_MPR_SAR_221_R02_3_03
        ID_MPR_SAR_221_R02_3_03 --> ID_MPR_SAR_221_R02_3_End
    end
    click ID_MPR_SAR_221_R02_3_01 href "#" "A programação para acompanhamento de voo de produção pela ANAC na frequência estabelecida pelo Policy File - 21.140 é realizada pela GTEV/CEVIS.  Após a realização do voo, a CEVIS envia um relatório para a GTCO/CPROD."
    click ID_MPR_SAR_221_R02_3_02 href "#" "A análise do relatório do voo de produção deve procurar identificar:  1. Se o voo foi realizado utilizando o procedimento aprovado;  2. Se as eventuais discrepâncias apontadas indicam alguma tendência adversa que necessite de ação corretiva por parte do fabricante."
    click ID_MPR_SAR_221_R02_3_01 href "#" "Ao identificar situação ou conduta que gere risco iminente à segurança de voo, à integridade física de pessoas, à coletividade, à ordem pública, à continuidade dos serviços prestados ou ao interesse público, o agente da ANAC no exercício de atividade de fiscalização deverá atuar de acordo com os artigos 57 a 60 da resolução 472.  A motivação para a suspensão cautelar deve ser registrada em uma nota técnica em um novo processo no SEI relacionado ao processo de fiscalização em andamento. A nota técnica deve conter no mínimo:  • Resumo da atividade de fiscalização através da qual foi identificada a necessidade de adoção da medida cautelar;  • Razão pela qual a situação identificada pode gerar risco iminente à segurança de voo, à integridade física de pessoas, à coletividade, à ordem pública, à continuidade dos serviços prestados ou ao interesse público;  • Quais medidas, corretivas ou mitigatórias, são esperadas para a revogação da suspensão cautelar.  Dependendo da situação encontrada durante atividade de fiscalização externa, a suspensão cautelar pode ser adotada imediatamente e notificada ao acautelado. A notificação deve ser assinada pelo acautelado e deve possuir o conteúdo estabelecido no Art. 58 da resolução 472.  Em caso de recusa do acautelado em assinar a notificação da medida acautelatória, a assinatura do servidor, acompanhada de uma anotação sobre o fato, suprirá a ciência do acautelado, conforme parágrafo 1º do Art. 58 da resolução 472/2018.  Neste caso, o auditor líder deve dar ciência à chefia imediata por telefone e a nota técnica deve ser elaborada após o retorno à sede, para documentar a ocorrência.  Quando for possível, é preferível que a medida seja adotada após o retorno do agente à sede, para que a documentação da situação e a ciência à chefia imediata ocorram antes da notificação ao acautelado.  A nota técnica deve ser assinada pelo(s) agente(s) que identificou(aram) a situação de risco e encaminhada, por e-mail dentro do processo SEI, para ciência do GTCO e do SAR."
    click ID_MPR_SAR_221_R02_3_02 href "#" "O agente que identificou a situação de risco deve elaborar um ofício para notificar o acautelado. De acordo com o artigo 58 da resolução 472/2018, o ofício deve conter no mínimo:  • A infração identificada, com a sua fundamentação;  • Documentos e providências necessárias para revogação da medida acautelatória;  • Identificação do acautelado e unidade responsável pela medida.  O agente deve, ainda, elaborar portaria para publicação da suspensão cautelar no diário oficial e um despacho para envio da portaria para a ASCOM.  O ofício deve ser encaminhado para assinatura do GTCO e envio ao acautelado (com AR).  A portaria e o despacho devem ser encaminhados para assinatura do GTCO e envio para a ASCOM para publicação no DOU."
    click ID_MPR_SAR_221_R02_3_03 href "#" "O GTCO deve assinar o ofício de notificação da medida cautelar, a portaria para publicação no DOU e o despacho de encaminhamento da portaria para a ASCOM."
    click ID_MPR_SAR_221_R02_3_04 href "#" "O agente que identificou a situação de risco deve acompanhar a implementação das providências necessárias para revogação da medida cautelar, conforme informado na notificação ao acautelado.  O acompanhamento deve ser registrado na Intranet da SAR, em um relatório de acompanhamento.  Caso o acautelado não se manifeste no prazo de 90 dias, o agente deve encaminhar novo ofício, com AR, solicitando a adoção das providências necessárias no prazo de 90 dias adicionais.  Caso o acautelado não se manifeste, decorridos os 180 dias, o agente deve encaminhar ofício informando que o COP será revogado caso não haja manifestação em 20 dias."
    click ID_MPR_SAR_221_R02_3_05 href "#" "Caso o acautelado não atenda aos prazos para manifestação e adoção das providências necessárias para revogação da medida cautelar, o COP deve ser revogado.  O agente que identificou a situação de risco deve elaborar um ofício para notificar o acautelado sobre a revogação do COP.  O agente deve, ainda, elaborar portaria para publicação da revogação do COP no diário oficial, e um despacho para envio da portaria para a ASCOM.  O ofício deve ser encaminhado para assinatura do GTCO e envio ao acautelado.  A portaria e o despacho devem ser encaminhados para assinatura do GTCO e envio para a ASCOM para publicação no DOU."
    click ID_MPR_SAR_221_R02_3_06 href "#" "Caso o acautelado adote as providências necessárias, a medida cautelar deve ser revogada.  O agente que identificou a situação de risco deve elaborar um ofício para notificar o acautelado sobre a revogação da medida cautelar.  O agente deve, ainda, elaborar portaria para publicação da revogação da medida cautelar no diário oficial, e um despacho para envio da portaria para a ASCOM.  O ofício deve ser encaminhado para assinatura do GTCO e envio ao acautelado.  A portaria e o despacho devem ser encaminhados para assinatura do GTCO e envio para a ASCOM para publicação no DOU."
    click ID_MPR_SAR_221_R02_3_07 href "#" "O GTCO deve assinar o ofício de notificação da revogação do COP ou da medida cautelar, a portaria para publicação no DOU e o despacho de encaminhamento da portaria para a ASCOM."
    click ID_MPR_SAR_221_R02_3_01 href "#" "O GTCO - CP deve analisar se o requerente enviou o comprovante de pagamento da TFAC relacionada à revisão do manual da qualidade, conforme ITD 121-03."
    click ID_MPR_SAR_221_R02_3_02 href "#" "As seções 21.138, 21.308 e 21.608 requerem que a ANAC aprove o manual da qualidade do requerente ou detentor de um COP. Revisões do manual da qualidade também devem ser aprovadas.  Ao receber uma proposta de alteração do manual da qualidade, o coordenador de produção deve verificar se os requisitos do RBAC 21 continuam sendo atendidos, utilizando o formulário F-300-28 – Questionário de avaliação de sistemas da qualidade, como referência.  O GTCO - CP deve inserir no processo um parecer contendo o resultado da análise."
    click ID_MPR_SAR_221_R02_3_03 href "#" "O GTCO - CP deve elaborar um ofício contendo o resultado da análise, aprovando ou não o manual da qualidade e encaminhar o ofício para assinatura do GTCO."
    click ID_MPR_SAR_221_R02_3_01 href "#" "O GTCO - CP deve analisar se a pessoa que assinou o requerimento para cancelamento do COP tem autorização para representar a empresa. Se for necessário, o GTCO - CP deve solicitar cópia do contrato social e procuração."
    click ID_MPR_SAR_221_R02_3_02 href "#" "O GTCO - CP deve elaborar ofício informando à empresa sobre o cancelamento do COP, como foi solicitado, e encaminhar o ofício para assinatura.  O GTCO - CP deve atualizar o status do COP na Intranet da SAR."
    click ID_MPR_SAR_221_R02_3_03 href "#" "O GTCO - CP deve elaborar uma portaria para dar publicidade ao cancelamento do COP. Esta atividade possui como artefato um modelo de portaria que pode ser utilizado."
    click ID_MPR_SAR_221_R02_3_01 href "#" "O detentor de um COP deve comunicar à ANAC, por escrito, qualquer alteração em seu sistema da qualidade ou na localização das instalações de fabricação que possam afetar inspeção, conformidade ou aeronavegabilidade.  Ao receber a notificação, o coordenador de produção deve verificar se os requisitos do RBAC 21 continuam sendo atendidos, utilizando o formulário F-300-28 – Questionário de avaliação de sistemas da qualidade, como referência.  Caso o GTCO - CP conclua que após a alteração o detentor do COP deixou de atender aos requisitos do RBAC 21, deve proceder diretamente para a etapa 3, de registro da análise.  Caso o GTCO - CP conclua que os requisitos continuam sendo atendidos, deve decidir se é necessária a realização de uma auditoria específica para avaliar a alteração, ou se a avaliação pode ser realizada na próxima auditoria agendada na empresa. Essa decisão é subjetiva e depende do conhecimento do GTCO - CP sobre o sistema da qualidade da empresa, considerando:  1. Se há alguma auditoria agendada para a empresa  2. Se o sistema da qualidade da empresa possui meios para gerir a alteração (ex. qualificação de processo, FAI, Try-Out, etc)  3. Se a localização de localização de algum processo especial ou crítico foi realizada.  O GTCO - CP deve elaborar um parecer para registrar a avaliação da necessidade de auditoria.  Caso a auditoria imediata seja necessária, o GTCO - CP deve encaminhar o processo com o parecer para o coordenador do grupo de produção para preparação de auditoria não programada.  Caso a verificação sobre a alteração possa ser realizada na próxima auditoria programada, o GTCO - CP deve manter registro da alteração para informar ao auditor líder no momento de elaboração do programa de auditoria."
    click ID_MPR_SAR_221_R02_3_02 href "#" "O GTCOCPROD definirá equipe e data para a realização da auditoria não programada para verificação da alteração no sistema da qualidade proposta.  Será gerado um novo processo no SEI, associado ao processo da comunicação da alteração, para a realização da auditoria. O processo de comunicação da modificação será devolvido para o GTCO - CP para acompanhamento.  Não é necessário o envio do programa de auditoria nem recolhimento de TFAC. O GTCO - CP explicará ao Auditor Líder o que é necessário verificar na auditoria não programada. As demais atividades da ITD-121-01 devem ser seguidas.  Caso sejam identificadas não conformidades, o Auditor Líder deve elaborar um relatório de auditoria e adotar as providências administrativas apropriadas.  Após a realização da auditoria, o Auditor Líder deve inserir no processo um parecer sobre o atendimento aos requisitos em relação às verificações solicitadas pelo GTCO - CP."
    click ID_MPR_SAR_221_R02_3_03 href "#" "O GTCO - CP deve elaborar um parecer contendo o resultado da análise (se o detentor do COP continua cumprindo com os requisitos do RBAC 21 ou se deixou de cumprir com algum requisito).  Caso o GTCO - CP conclua que após a alteração o detentor do COP deixou de atender aos requisitos do RBAC 21, deve elaborar um ofício solicitando que a empresa desfaça a alteração, retornando o sistema da qualidade à condição da certificação. O GTCO - CP deve, então, encaminhar o ofício para assinatura do GTCO."
```
...
flowchart TD
    ...
    subgraph Container_ID_MPR_SAR_221_R02_2 [ ]
        ...
        ID_MPR_SAR_221_R02_2_01("<b>01. Acompanhar o quality escape</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_01("<b>01. Realizar o voo de produção</b><hr>Responsável: Coordenadoria de Aeronáutica, Ensaios em Voo e Integração de Sistemas."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_02("<b>02. Analisar relatório de voo de produção</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_01("<b>01. Elaborar nota técnica</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_02("<b>02. Elaborar ofício e portaria</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_03("<b>03. Assinar documentos de adoção de medida cautelar</b><hr>Responsável: O Gtco."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_04("<b>04. Acompanhar a implementação das providências</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_05("<b>05. Revogar o COP</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_06("<b>06. Revogar a medida cautelar</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_07("<b>07. Assinar documentos</b><hr>Responsável: O Gtco."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_02("<b>02. Analisar Manual da Qualidade</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_03("<b>03. Elaborar Ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_02("<b>02. Elaborar ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_03("<b>03. Elaborar Portaria para publicação no DOU</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_01("<b>01. Analisar a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_02("<b>02. Realizar auditoria</b><hr>Responsável: GTCO - Equipe Auditora."):::tarefaBPMN
        ID_MPR_SAR_221_R02_2_03("<b>03. Deliberar sobre a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
...
flowchart TD
    ...
    subgraph Container_ID_MPR_SAR_221_R02_1 [ ]
        ...
        ID_MPR_SAR_221_R02_1_01("<b>01. Iniciar processo</b><hr>Responsável: Gtco - Coordenador CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_02("<b>02. Planejar a auditoria</b><hr>Responsável: GTCO - Auditor Líder."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_03("<b>03. Realizar auditoria</b><hr>Responsável: GTCO - Equipe Auditora."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_04("<b>04. Emitir o relatório de auditoria</b><hr>Responsável: GTCO - Auditor Líder."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_05("<b>05. Emitir parecer sobre o relatório</b><hr>Responsável: Gtco - Coordenador CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_06("<b>06. Realizar análise de risco</b><hr>Responsável: GTCO - Auditor Líder."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_08("<b>08. Revalidar o COP</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_01("<b>01. Acompanhar o quality escape</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_01("<b>01. Realizar o voo de produção</b><hr>Responsável: Coordenadoria de Aeronáutica, Ensaios em Voo e Integração de Sistemas."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_02("<b>02. Analisar relatório de voo de produção</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_01("<b>01. Elaborar nota técnica</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_02("<b>02. Elaborar ofício e portaria</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_03("<b>03. Assinar documentos de adoção de medida cautelar</b><hr>Responsável: O Gtco."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_04("<b>04. Acompanhar a implementação das providências</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_05("<b>05. Revogar o COP</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_06("<b>06. Revogar a medida cautelar</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_07("<b>07. Assinar documentos</b><hr>Responsável: O Gtco."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_02("<b>02. Analisar Manual da Qualidade</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_03("<b>03. Elaborar Ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_02("<b>02. Elaborar ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_03("<b>03. Elaborar Portaria para publicação no DOU</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_01("<b>01. Analisar a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_02("<b>02. Realizar auditoria</b><hr>Responsável: GTCO - Equipe Auditora."):::tarefaBPMN
        ID_MPR_SAR_221_R02_1_03("<b>03. Deliberar sobre a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
...
flowchart TD
    ...
    subgraph Container_ID_MPR_SAR_221_R02_0 [ ]
        ...
        ID_MPR_SAR_221_R02_0_01("<b>01. Analisar a necessidade de auditorias em fornecedores de cada empresa</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_02("<b>02. Elaborar Escala de Auditorias</b><hr>Responsável: Gtco - Coordenador CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_01("<b>01. Iniciar processo</b><hr>Responsável: Gtco - Coordenador CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_02("<b>02. Planejar a auditoria</b><hr>Responsável: GTCO - Auditor Líder."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_03("<b>03. Realizar auditoria</b><hr>Responsável: GTCO - Equipe Auditora."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_04("<b>04. Emitir o relatório de auditoria</b><hr>Responsável: GTCO - Auditor Líder."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_05("<b>05. Emitir parecer sobre o relatório</b><hr>Responsável: Gtco - Coordenador CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_06("<b>06. Realizar análise de risco</b><hr>Responsável: GTCO - Auditor Líder."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_08("<b>08. Revalidar o COP</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_01("<b>01. Acompanhar o quality escape</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_01("<b>01. Realizar o voo de produção</b><hr>Responsável: Coordenadoria de Aeronáutica, Ensaios em Voo e Integração de Sistemas."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_02("<b>02. Analisar relatório de voo de produção</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_01("<b>01. Elaborar nota técnica</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_02("<b>02. Elaborar ofício e portaria</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_03("<b>03. Assinar documentos de adoção de medida cautelar</b><hr>Responsável: O Gtco."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_04("<b>04. Acompanhar a implementação das providências</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_05("<b>05. Revogar o COP</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_06("<b>06. Revogar a medida cautelar</b><hr>Responsável: CPROD."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_07("<b>07. Assinar documentos</b><hr>Responsável: O Gtco."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_02("<b>02. Analisar Manual da Qualidade</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_03("<b>03. Elaborar Ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_01("<b>01. Analisar requerimento</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_02("<b>02. Elaborar ofício</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_03("<b>03. Elaborar Portaria para publicação no DOU</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_01("<b>01. Analisar a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_02("<b>02. Realizar auditoria</b><hr>Responsável: GTCO - Equipe Auditora."):::tarefaBPMN
        ID_MPR_SAR_221_R02_0_03("<b>03. Deliberar sobre a alteração</b><hr>Responsável: Gtco - Cordenador de Produção."):::tarefaBPMN
