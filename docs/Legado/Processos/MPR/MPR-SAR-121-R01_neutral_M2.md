# MPR/SAR-121-R01 - CERTIFICAÇÃO DE ORGANIZAÇÃO DE PRODUÇÃO
...
| R00 | Portaria Nº 1.350, de 18 de Abril de 2017 | Não informado | SAR | Versão Original |
| R01 | PORTARIA Nº 5.894, DE 10 DE SETEMBRO DE 2021 | Não informado | SAR | 1) Processo 'Analisar Requerimento de Certificação de Organização de Produção' removido.  2) Processo 'Analisar Documentação para Certificação de Organização de Produção' removido.  3) Processo 'Realizar Auditoria de Avaliação Inicial de Certificação de Organização de Produção' removido.  4) Processo 'Realizar Inspeção de Conformidade de Primeiro Artigo' removido.  5) Processo 'Emitir Minuta de Certificado de Organização de Produção' removido.  6) Processo 'Gerir Alterações no Sistema de Gestão da Qualidade de Detentores de COP' removido.  7) Processo 'Revalidar Certificado de Organização de Produção' removido.  8) Processo 'Cancelar ou Suspender Certificado de Organização de Produção' removido.  9) Processo 'Certificar Organização de Produção' inserido. |
...
4.1) Realizar Auditoria em Organização de Produção, pág.12.

4.2) Acompanhar o Tratamento de Quality Escape Junto ao Fabricante, pág.12.

4.3) Acompanhar Voo de Produção, pág.12.

5) Procedimentos, pág. 13.

5.1) Certificar Organização de Produção, pág. 13.
...
1) Certificar Organização de Produção

**b) Gtco - Coordenador CPROD**

1) Certificar Organização de Produção

**c) Gtco - Cordenador de Produção**

1) Certificar Organização de Produção

**d) GTCO - Equipe Auditora**
...
Esta revisão foi conduzida através do processo SEI nº 00058.014442/2020-20.

O A seção 21-6 do RBAC 21 estabelece que uma pessoa somente pode fabricar uma aeronave nova, um motor de aeronave novo ou uma hélice nova conforme um certificado de tipo se ela for detentora (ou licenciada) de um certificado de tipo e se for detentora ou estiver em processo de obtenção de um COP, segundo as subpartes F e G do RBAC 21.

Já a seção 21.9 estabelece que uma pessoa que produza um artigo para reposição ou modificação só pode vender este artigo como apto a ser instalado em um produto de tipo certificado se for detentora de uma aprovação de produção segundo as subpartes K ou O.

A IS 21-006 apresenta para os requerentes as etapas do processo de obtenção de um COP e a forma de demonstrar o atendimento aos requisitos das subpartes G, K ou O do RBAC 21.

Este MPR estabelece a forma de atuação e as responsabilidades dos servidores da ANAC responsáveis pela certificação de organizações produção na verificação do atendimento aos requisitos em cada uma das etapas do processo de certificação de organização de produção.

As seguintes diretrizes pautaram a elaboração deste MPR:

1. O MPR deve fornecer ao servidor que atua na certificação de organizações de produção as informações necessárias para o desempenho de suas atividades;

2. O MPR deve possibilitar a atuação de forma padronizada dos diferentes servidores atuando no processo de certificação de organizações de produção;

3. O MPR deve buscar assegurar que as verificações de atendimento aos requisitos mínimos sejam sempre realizadas.

O MPR estabelece, no âmbito da Superintendência de Aeronavegabilidade - SAR, o seguinte processo de trabalho:

a) Certificar Organização de Produção.

**1.2 REVOGAÇÃO**

MPR/SAR-121-R00, aprovado na data de 18 de abril de 2017.
...
| Fabricante | Pessoa que detém os dados do projeto aprovado e é capaz de determinar a conformidade do produto/artigo com o projeto aprovado. |
...
| CBAER | Código Brasileiro de Aeronáutica, representado pela Lei nº 7.565, de 19 de dezembro de 1986. |
...
| RLP | Registro de Limitações de Produção |
...
| F-121-07 - Plano de Certificação | Formulário para planejamento de Certificação de Organização de Produção. |
...
| GTCO - Nota Técnica para COP | Modelo de nota técnica para emissão de Certificado de Organização de Produção. |
| GTCO - Portaria para Publicação de COP | Modelo de portaria para publicação de Certificado de Organização de Produção. |
| ITD-121-01 | Auditoria no Sistema de Organização de Produção. |
| ITD-121-03 | TFAC aplicáveis às atividades de competência da GTCO. |
| ITD-121-04 | Análise da documentação para Certificação de Empresas de acordo com o RBAC 21 - Subparte G. |
| ITD-121-05 | Inspeção de Primeiro Artigo. |
...
| Elabora Relatório de Auditoria da Qualidade, de forma organizada e objetiva, utilizando as regras das ISOs 19011, 9001 e 10015 e dos manuais da Qualidade-MQ- e de Instruções e Procedimentos-MIP. | GTCO - Equipe Auditora |
