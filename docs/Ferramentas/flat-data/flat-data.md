...
O Flat Data evita a complexidade de muitas ferramentas no espaço de dados/ETL em favor de algo simples e flexível o suficiente para muitas cargas de trabalho, mas que não requer que a infraestrutura seja mantida num servidor do usuário.
